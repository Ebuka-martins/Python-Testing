...
class TestStudent(unittest.TestCase):
    ...
    def test_apply_extension(self):
        ...
        initial_end_date = self.student.end_date
        self.student.apply_extension(30)  # Add 30 days
        self.assertEqual(self.student.end_date, initial_end_date + timedelta(days=30))
